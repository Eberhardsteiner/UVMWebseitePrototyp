      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Benutzerrechte</h2>
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Speicherung</h2>
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Grundlage für die Datenerfassung</h2>
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Welche Daten werden erfasst?</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Wie erhalten wir Daten über Sie?</h2>
            <p className="text-gray-700 mb-2">Wir beziehen Ihre personenbezogenen Daten aus verschiedenen Quellen:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Wie werden die Daten genutzt? An wen werden die Daten weitergegeben?</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
              Wir geben Benutzerdaten nicht an Dritte weiter, außer wie in diesen Datenschutzbestimmungen beschrieben.
            </p>
            <p className="text-gray-700 mb-2">Wir verwenden Daten für folgende Zwecke:</p>
          ...
          <section className="pt-6 border-t border-gray-200">
            ...
            <p className="text-gray-700 mb-3">Diese Webseite verwendet folgende Arten von Cookies:</p>
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Verwendung von Skriptbibliotheken (Google Web Fonts)</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Erfassung von Daten durch Dritte</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Wie schützen wir Ihre Daten?</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Übermittlung von Daten außerhalb des Europäischen Wirtschaftsraums</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Werbung</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Unternehmenstransaktion</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Minderjährige</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Aktualisierungen oder Änderungen dieser Datenschutzbestimmungen</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">So erreichen Sie uns</h2>
